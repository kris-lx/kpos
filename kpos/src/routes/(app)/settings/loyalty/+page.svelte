    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                <div>
                    <label for="a11y-app-settings-loyalty-page-svelte-1" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ຊື່ໂປຣແກຣມ</label>
                    <input id="a11y-app-settings-loyalty-page-svelte-1"
                        type="text"
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label for="a11y-app-settings-loyalty-page-svelte-2" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ອັດຕາໄດ້ຮັບ</label>
                        <div class="relative">
                            <input id="a11y-app-settings-loyalty-page-svelte-2"
                                type="number"
                    ...
                    <div>
                        <label for="a11y-app-settings-loyalty-page-svelte-3" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ອັດຕາແລກ</label>
                        <div class="relative">
                            <input id="a11y-app-settings-loyalty-page-svelte-3"
                                type="number"
                ...
                <div>
                    <label for="a11y-app-settings-loyalty-page-svelte-4" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ຄະແນນໝົດອາຍຸ</label>
                    <div class="relative">
                        <input id="a11y-app-settings-loyalty-page-svelte-4"
                            type="number"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-hidden shadow-2xl">
            ...
            <div class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                <div class="flex gap-4">
                    <div class="flex-1">
                        <label for="a11y-app-settings-loyalty-page-svelte-5" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ຊື່ລະດັບ</label>
                        <input id="a11y-app-settings-loyalty-page-svelte-5"
                            type="text"
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div>
                        <label for="a11y-app-settings-loyalty-page-svelte-6" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ຄະແນນຂັ້ນຕ່ຳ</label>
                        <input id="a11y-app-settings-loyalty-page-svelte-6"
                            type="number"
                    ...
                    <div>
                        <label for="a11y-app-settings-loyalty-page-svelte-7" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ສ່ວນຫຼຸດ %</label>
                        <input id="a11y-app-settings-loyalty-page-svelte-7"
                            type="number"
                    ...
                    <div>
                        <label for="a11y-app-settings-loyalty-page-svelte-8" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ຄູນຄະແນນ</label>
                        <input id="a11y-app-settings-loyalty-page-svelte-8"
                            type="number"
                ...
                <div>
                    <label for="a11y-app-settings-loyalty-page-svelte-9" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">ສິດທິພິເສດ</label>
                    <div class="flex gap-2 mb-2">
                        <input id="a11y-app-settings-loyalty-page-svelte-9"
                            type="text"
